<template>
  <div class="min-h-screen bg-app-bg flex flex-col">
    ...
    <div class="px-4 pb-2">
      <div class="flex gap-2 overflow-x-auto pb-1 no-scrollbar">
        <button
          ...
          :class="selectedCategoryFilter === null ? 'bg-violet-500/20 border-violet-500/50 text-violet-300' : 'bg-app-card border-app-border text-muted hover:text-primary'"
        >
          Todas
        </button>
        <button
    ...
    <button
      ...
      style="background: linear-gradient(135deg, #8b5cf6, #6366f1); box-shadow: 0 8px 24px #8b5cf640"
    >
