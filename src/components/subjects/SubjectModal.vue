          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-2">
                <button
                  ...
                  :class="form.icon === icon ? 'bg-violet-500/30 ring-2 ring-violet-500' : 'bg-app-elevated hover:bg-app-elevated'"
                >
                  {{ icon }}
                </button>
              </div>
            ...
            <div>
              ...
              <select
                ...
                class="w-full bg-app-elevated border border-app-border rounded-xl px-4 py-3 text-primary focus:outline-none focus:border-violet-500 transition-colors"
              >
